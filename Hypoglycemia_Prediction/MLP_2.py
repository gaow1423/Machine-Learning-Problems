...
features, targets = dataprocessing("Subject_7_part1.csv")#3130
...
valid_data = np.array(list(csv.reader(open("subject7_instances.csv", "r"), delimiter=",")))
...
#            count += 1
#    print(count)
    writeintocsv(prediction_file.T, "./prediction_file/individual2_pred3.csv")
